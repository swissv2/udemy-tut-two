        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <!-- insert tailwind table here -->
                      <div class="sm:flex sm:items-center">
                          <div class="sm:flex-auto">
                          <h1 class="text-xl font-semibold text-gray-900">Posts</h1>
                          <p class="mt-2 text-sm text-gray-700">A list of posts and such in your database, and such. Click on a title to read the post!</p>
                          </div>
                          <!-- allow qualified posting -->
                          @can('create', App\Models\Post::class)
                            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                              <a href="{{ route('posts.create') }}">
                                <button type="button" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">New Post</button>
                              </a>
                            </div>
                          @endcan
                                          ...
                                          <td class="flex whitespace-nowrap py-4 pl-3 pr-4 text-right float-right text-sm font-medium sm:pl-6">
                                            ...
                                            @can('delete', $post)
                                              <form method="POST"
                                                ...
                                                @csrf
                                                @method('DELETE')
                                                [<button type="submit" class="text-right text-red-600 hover:text-red-900 hover:underline"> Delete </button>]
                                              </form>
                                            @endcan
